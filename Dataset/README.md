...
Data used to train the model in the repository can be downloaded [here]([https://drive.google.com/file/d/1AiUt7TuIUcVLb3M_iM99yGhJTtuhOB_x/view?usp=sharing](https://drive.google.com/file/d/10jgnLMyABmA9Arg-M6go1Khlk3Eyyois/view?usp=sharing)). Training data is the en-vi language pair of the [OPUS TED2020v1 data](https://opus.nlpl.eu/TED2020-v1.php).   
